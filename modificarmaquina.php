<!DOCTYPE html>
   ...
   <?php
    ...
    if ($cambiaren == 1) {
      $pregunta = " update maquinas set Tipo_maquina='$cambiarpor' where Id_maquina=$id; ";
    } elseif ($cambiaren == 2) {
      $pregunta = "update maquinas set Musculo_trabaja='$cambiarpor' where Id_maquina=$id; ";
...
echo "<a href=listamaquina.php>--volver atrás</a>";
 ?>
