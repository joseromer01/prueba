...
<?php
    ...
    $nueva = "insert into clientes values(null,'$nombre','$apellido', '$genero','$fecha_nacimiento', '$fecha_ingreso', '$fecha_fin');";
    ...
    $nueva6 = "insert into plan_pago_cliente('$id','$plan_pago',' $monto_bs');";
    $resultado6 = $dblink->query($nueva6);
