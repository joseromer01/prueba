<!DOCTYPE html>
   ...
   <?php
    ...
    if ($cambiaren == 1) {
      $pregunta = " update rutinas set Nombre_ejercicio='$cambiarpor' where Id_rutina=$id; ";
    } elseif ($cambiaren == 2) {
      $pregunta = "update rutinas set Tipo_de_rutina='$cambiarpor' where Id_rutina=$id; ";
...
echo "<a href=listarutina.php>--volver atrás</a>";
 ?>
